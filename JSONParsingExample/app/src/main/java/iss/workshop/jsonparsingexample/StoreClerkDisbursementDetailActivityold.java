...
public class StoreClerkDisbursementDetailActivityold extends AppCompatActivity implements GetRawData.OnDownloadComplete {
        ...
        if(status == DownloadStatus.OK) {
            ...
            try {
                ...
                for(int i=0; i<itemsArray.length(); i++) {
                    ...
                    disbursementDetail.setA_Date(jsonDisbursementDetail.getString("A_Date"));
                ...
                disRecyclerViewAdapter.loadNewData(mDisbursementDetail);
